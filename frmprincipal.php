    ...
    <div class="card-body">
        <div class="container-projeto">
            ...
            <p class="paragrafo-projeto">
                Nós somos alunos da faculdade Univesp e criamos esse projeto com intuito de auxiliar a escola Etec Monte Mor
            ...
            <ul class="lista-projeto">
                ...
                <li class="item-projeto">Cursos: 
                    <span class="texto-projeto">Tecnologia de Informação | Ciência de Dados | Engenharia da Computação</span>
                </li>
            ...
            <p class="paragrafo-projeto">
                Esse projeto foi desenvolvido com o intuito de auxiliar a escola Etec Monte Mor a identificar os veículos e seus respectivos donos em caso de problemas no estacionamento.
            </p>

            <!-- Botões de Login e Cadastro -->
            <div style="margin-top: 2em; text-align: center;">
                <a href="login.php" class="btn btn-primary" style="margin: 0 1em;">Login</a>
                <a href="cadastro.php" class="btn btn-success" style="margin: 0 1em;">Cadastrar-se</a>
            </div>
        </div>
    </div>
</div>